...
export default function OAuthButtons() {
  ...
  return (
    <button
      ...
      className='flex items-center justify-center gap-2 w-full px-4 py-2.5 border border-slate-300 rounded-lg hover:bg-slate-50 text-sm font-medium text-slate-700'
    >
