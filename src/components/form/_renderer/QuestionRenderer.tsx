...
export function QuestionRenderer({ q, d, answers, onAnswer }: Props) {
  switch (q.type) {
    case 'short_text':
      return <ShortText q={q} d={d} answers={answers} onAnswer={onAnswer} />
    case 'long_text':
      return <LongText q={q} d={d} answers={answers} onAnswer={onAnswer} />
    case 'multiple_choice':
      return <MultipleChoice q={q} d={d} answers={answers} onAnswer={onAnswer} />
    case 'checkboxes':
      return <Checkboxes q={q} d={d} answers={answers} onAnswer={onAnswer} />
    case 'dropdown':
      return <Dropdown q={q} d={d} answers={answers} onAnswer={onAnswer} />
    case 'rating':
      return <Rating q={q} d={d} answers={answers} onAnswer={onAnswer} />
    case 'date':
      return <DateInput q={q} d={d} answers={answers} onAnswer={onAnswer} />
    case 'file_upload':
